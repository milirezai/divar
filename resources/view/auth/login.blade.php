                                    ...
                                    <div class="card-body pt-1">
                                        <form action="<?= route('auth.login') ?>" method="post">
                                            ...
                                            <div class="form-group d-flex justify-content-between align-items-center">
                                                ...
                                                <div class="text-right"><a href="<?= route('auth.forgot.show') ?>" class="card-link">رمز خود را فراموش کرده ام؟</a></div>
                                            </div>
                                            <a href="<?= route('auth.register.show') ?>" class="btn btn-outline-primary float-left btn-inline">ثبت نام</a>
